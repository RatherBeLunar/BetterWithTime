...
public class CauldronScreenHandler extends AbstractCookingPotScreenHandler {
    public CauldronScreenHandler(int syncId, PlayerInventory playerInventory, AbstractCookingPotData cookingPotData) {
        this(syncId, playerInventory, new SimpleInventory(SIZE), new ArrayPropertyDelegate(1), cookingPotData);
    }

    public CauldronScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory, PropertyDelegate propertyDelegate, AbstractCookingPotData cookingPotData) {
