...
public class BwtRecipes implements ModInitializer {
    ...
    public void onInitialize() {
        Registry.register(BuiltInRegistries.RECIPE_TYPE, Id.of("block_dispenser_clump"), BLOCK_DISPENSER_CLUMP_RECIPE_TYPE);
        Registry.register(BuiltInRegistries.RECIPE_SERIALIZER, Id.of("block_dispenser_clump"), BLOCK_DISPENSER_CLUMP_RECIPE_SERIALIZER);
        Registry.register(BuiltInRegistries.RECIPE_TYPE, Id.of("cauldron"), CAULDRON_RECIPE_TYPE);
        Registry.register(BuiltInRegistries.RECIPE_SERIALIZER, Id.of("cauldron"), CAULDRON_RECIPE_SERIALIZER);
        Registry.register(BuiltInRegistries.RECIPE_TYPE, Id.of("stoked_cauldron"), STOKED_CAULDRON_RECIPE_TYPE);
        Registry.register(BuiltInRegistries.RECIPE_SERIALIZER, Id.of("stoked_cauldron"), STOKED_CAULDRON_RECIPE_SERIALIZER);
        Registry.register(BuiltInRegistries.RECIPE_TYPE, Id.of("crucible"), CRUCIBLE_RECIPE_TYPE);
        Registry.register(BuiltInRegistries.RECIPE_SERIALIZER, Id.of("crucible"), CRUCIBLE_RECIPE_SERIALIZER);
        Registry.register(BuiltInRegistries.RECIPE_TYPE, Id.of("stoked_crucible"), STOKED_CRUCIBLE_RECIPE_TYPE);
        Registry.register(BuiltInRegistries.RECIPE_SERIALIZER, Id.of("stoked_crucible"), STOKED_CRUCIBLE_RECIPE_SERIALIZER);
        Registry.register(BuiltInRegistries.RECIPE_TYPE, Id.of("mill_stone"), MILL_STONE_RECIPE_TYPE);
        Registry.register(BuiltInRegistries.RECIPE_SERIALIZER, Id.of("mill_stone"), MILL_STONE_RECIPE_SERIALIZER);
        Registry.register(BuiltInRegistries.RECIPE_TYPE, Id.of("mob_spawner_conversion"), MOB_SPAWNER_CONVERSION_RECIPE_TYPE);
        Registry.register(BuiltInRegistries.RECIPE_SERIALIZER, Id.of("mob_spawner_conversion"), MOB_SPAWNER_CONVERSION_RECIPE_SERIALIZER);
        Registry.register(BuiltInRegistries.RECIPE_TYPE, Id.of("hopper_filter"), HOPPER_FILTER_RECIPE_TYPE);
        Registry.register(BuiltInRegistries.RECIPE_SERIALIZER, Id.of("hopper_filter"), HOPPER_FILTER_RECIPE_SERIALIZER);
        Registry.register(BuiltInRegistries.RECIPE_TYPE, Id.of("soul_bottling"), SOUL_BOTTLING_RECIPE_TYPE);
        Registry.register(BuiltInRegistries.RECIPE_SERIALIZER, Id.of("soul_bottling"), SOUL_BOTTLING_RECIPE_SERIALIZER);
        Registry.register(BuiltInRegistries.RECIPE_TYPE, Id.of("saw"), SAW_RECIPE_TYPE);
        Registry.register(BuiltInRegistries.RECIPE_SERIALIZER, Id.of("saw"), SAW_RECIPE_SERIALIZER);
        Registry.register(BuiltInRegistries.RECIPE_TYPE, Id.of("turntable"), TURNTABLE_RECIPE_TYPE);
        Registry.register(BuiltInRegistries.RECIPE_SERIALIZER, Id.of("turntable"), TURNTABLE_RECIPE_SERIALIZER);
        Registry.register(BuiltInRegistries.RECIPE_TYPE, Id.of("kiln"), KILN_RECIPE_TYPE);
        Registry.register(BuiltInRegistries.RECIPE_SERIALIZER, Id.of("kiln"), KILN_RECIPE_SERIALIZER);
        Registry.register(BuiltInRegistries.RECIPE_TYPE, Id.of("soul_forge"), SOUL_FORGE_RECIPE_TYPE);
        Registry.register(BuiltInRegistries.RECIPE_SERIALIZER, Id.of("soul_forge_shaped"), SOUL_FORGE_SHAPED_RECIPE_SERIALIZER);
        Registry.register(BuiltInRegistries.RECIPE_SERIALIZER, Id.of("soul_forge_shapeless"), SOUL_FORGE_SHAPELESS_RECIPE_SERIALIZER);
        Registry.register(BuiltInRegistries.RECIPE_TYPE, Id.of("disabled"), DISABLED_RECIPE_TYPE);
        Registry.register(BuiltInRegistries.RECIPE_SERIALIZER, Id.of("disabled"), DISABLED_RECIPE_SERIALIZER);
    }
}
