...
public class BwtItemTags {
    ...
    public static final TagKey<Item> CAN_INFERNAL_ENCHANT = TagKey.of(RegistryKeys.ITEM, Id.of("bwt", "can_infernal_enchant"));

    public static final TagKey<Item> INFERNAL_ENCHANTABLE_HELMETS = TagKey.of(RegistryKeys.ITEM, Id.of("bwt", "infernal_enchantable/helmets"));
    public static final TagKey<Item> INFERNAL_ENCHANTABLE_CHESTPLATES = TagKey.of(RegistryKeys.ITEM, Id.of("bwt", "infernal_enchantable/chestplates"));
    public static final TagKey<Item> INFERNAL_ENCHANTABLE_LEGGINGS = TagKey.of(RegistryKeys.ITEM, Id.of("bwt", "infernal_enchantable/leggings"));
    public static final TagKey<Item> INFERNAL_ENCHANTABLE_BOOTS = TagKey.of(RegistryKeys.ITEM, Id.of("bwt", "infernal_enchantable/boots"));
    public static final TagKey<Item> INFERNAL_ENCHANTABLE_ARMOR = TagKey.of(RegistryKeys.ITEM, Id.of("bwt", "infernal_enchantable/armor"));

    public static final TagKey<Item> INFERNAL_ENCHANTABLE_PICKAXE = TagKey.of(RegistryKeys.ITEM, Id.of("bwt", "infernal_enchantable/pickaxe"));
    public static final TagKey<Item> INFERNAL_ENCHANTABLE_TOOL = TagKey.of(RegistryKeys.ITEM, Id.of("bwt", "infernal_enchantable/tool"));
    public static final TagKey<Item> INFERNAL_ENCHANTABLE_SWORD = TagKey.of(RegistryKeys.ITEM, Id.of("bwt", "infernal_enchantable/sword"));
    public static final TagKey<Item> INFERNAL_ENCHANTABLE_MELEE_WEAPON = TagKey.of(RegistryKeys.ITEM, Id.of("bwt", "infernal_enchantable/melee_weapon"));
    public static final TagKey<Item> INFERNAL_ENCHANTABLE_DURABLITY = TagKey.of(RegistryKeys.ITEM, Id.of("bwt", "infernal_enchantable/durability"));

    public static final Map<Enchantment, TagKey<Item>> CAN_APPLY_INFERNAL_ENCHANT_TO = Registries.ENCHANTMENT.getKeys().stream().map( key -> Pair.of(Registries.ENCHANTMENT.get(key), TagKey.of(RegistryKeys.ITEM, Id.of("bwt", "infernal_enchantments/" + key.getValue().getPath())))).collect(Collectors.toMap(Pair::getLeft, Pair::getRight));
}
