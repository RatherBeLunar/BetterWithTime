...
public class BwtBlockTags {
    ...
    public static final TagKey<Block> CAN_CONVERT_TO_PODZOL = TagKey.of(RegistryKeys.BLOCK, new Identifier("bwt", "can_convert_to_podzol"));
    public static final TagKey<Block> CAN_CONVERT_TO_PODZOL_SLAB = TagKey.of(RegistryKeys.BLOCK, new Identifier("bwt", "can_convert_to_podzol_slab"));
}
