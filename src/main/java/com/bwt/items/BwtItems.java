...
//	public static final Item tannedLeatherTunicItem = Registry.register(Registries.ITEM, Id.of("tanned_leather_tunic"), new TannedLeatherTunicItem(new Item.Settings()));
	...
	public static final Item woodBladeItem = Registry.register(Registries.ITEM, Id.of("bwt", "wood_blade"), new Item(new Item.Settings()));
    public static final ArcaneTomeItem arcaneTome = Registry.register(Registries.ITEM, Id.of("bwt", "arcane_tome"), new ArcaneTomeItem(new Item.Settings().maxCount(1).rarity(Rarity.UNCOMMON).component(BwtDataComponents.ARCANE_ENCHANTMENT_COMPONENT, ArcaneEnchantmentComponent.DEFAULT).component(DataComponentTypes.ENCHANTMENT_GLINT_OVERRIDE, true)));
